...
var translations = map[string]map[string]string{
	localeEnglish: {
		...
		"task.scan.recovery_candidates":    "Quota recovery probes: candidates=%d due=%d uninitialized=%d selected=%d selected_due=%d",
	...
	localeChinese: {
		...
		"task.scan.recovery_candidates":    "额度恢复探测：候选=%d，到期=%d，未初始化=%d，本轮选择=%d，到期入选=%d",
